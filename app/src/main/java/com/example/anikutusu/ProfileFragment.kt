...
class ProfileFragment : Fragment(R.layout.fragment_profile) {
    ...
    private fun attachMyProfileHeaderListener() {
        ...
        // Tek seferlik değil, realtime dinleyelim ki sayılar anında güncellensin
        ...
        headerListener = object : ValueEventListener {
            override fun onDataChange(snapshot: DataSnapshot) {
                ...
                // ---- following count ----
                // NOT: DB’deki dal adı "userFollowingList"
                ...
                // ---- followers count ----
                // ÖNEMLİ: Doğru dal adı "userFollowerList" (çoğul değil!)
